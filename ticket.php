...
$insecion = "INSERT INTO ticket(numserie,fecha,nombre,direccion,rfc,descripcion,iva,descuento,importe,formapago,correo) VALUES (1,'$fecha','$nombre','$direccion','$rfc','$descripcion','$iva','$descuento','$total','$pago','$correo')";
$resultado = $mysqli->query($insecion);
